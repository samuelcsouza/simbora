...
export class AppController {
  ...
  async getDevice1Message(@Payload() message: { payload: string }) {
    console.log(
  ...
  async getDevice2Message(@Payload() message: { payload: string }) {
    console.log(
  ...
  async getDevice3Message(@Payload() message: { payload: string }) {
    console.log(
